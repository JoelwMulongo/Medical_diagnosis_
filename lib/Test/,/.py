...
This will create a my-project directory:
 ...
 ├── pyproject.toml
 ├── README.rst
 ├── poetry_demoPoetry is a tool for dependency management and packaging in Python. It allows you to declare the libraries your project depends on and it will manage (install/update) them for you.
...
The pyproject.toml file will orchestrate your project and its dependencies:
 ...
 [tool.poetry.dependencies]Poetry is a tool for dependency management and packaging in Python. It allows you to declare the libraries your project depends on and it will manage (install/update) them for you.
...
--------------
poetry installPoetry is a tool for dependency management and packaging in Python. It allows you to declare the libraries your project depends on and it will manage (install/update) them for you.
...
The pyproject.toml file will orchestrate your project and its dependencies:
 ...
 [tool.poetry]Poetry is a tool for dependency management and packaging in Python. It allows you to declare the libraries your project depends on and it will manage (install/update) them for you.
...
To remove dependencies:
----------------------
poetry remove pendulumPoetry is a tool for dependency management and packaging in Python. It allows you to declare the libraries your project depends on and it will manage (install/update) them for you.
